...
function generateDemoResponse(userMessage) {
  // Simple demo response generator - each response has 3 blocks
  const responses = [
    {
      trigger: /안녕|하이|헬로/i,
      response: `**나은** | "...왔구나."
...
마지막 말은 거의 들리지 않을 정도로 작았다. 손가락이 창틀을 가볍게 두드렸다.

**나은** | "...앉아."

그녀가 소파 쪽을 턱으로 가리켰다. 어색한 침묵이 방 안을 채웠다.`,
    },
    {
...
그녀가 도전적으로 눈을 치켜떴다. 하지만 목소리는 떨리고 있었다.`,
    },
    {
      trigger: /좋아|사랑/i,
...
그녀가 고개를 숙이며 작게 웃었다. 어깨가 미세하게 떨렸다.`,
    },
    {
      trigger: /싫어|미워/i,
      response: `[MOOD:sad]
...
창밖을 향해 돌아선 그녀의 어깨가 가늘게 떨리고 있었다.`,
    },
    {
...
수아가 두 사람을 번갈아 보며 물었다. 장난기 어린 눈빛이었다.`,
    },
    {
...
창밖의 비가 더욱 거세졌다. 번개가 방 안을 하얗게 물들였다.

**나은** | "...도망치지 마."

그녀의 손이 천천히 뻗어왔다. 숨이 막힐 것 같았다.`,
    },
  ];
...
그녀가 마침내 고개를 돌렸다. 창백한 얼굴 위로 네온 불빛이 일렁였다.`;
